...
export const About = () => {
  return (
    <div className="!min-h-[650px] w-full ">
      <h1 id="about" className=" text-4xl text-center mt-20 font-bold ">
        About
      </h1>
      <div className="min-h-[300px] ml-12 mt-8 flex justify-evenly gap-12">
        ...
        <div className="mt-4">
          ...
          <h2 className="text-3xl  font-bold mt-2">Our Mission</h2>
          <p className="text-xl  mt-2">
            Our mission is to provide the best services to our customers and to
            make sure they are satisfied
            <br /> with our work.
          </p>
          <h2 className="text-3xl  font-bold mt-2">Our Vision</h2>
          <p className="text-xl  mt-2">
